...
\subsubsection{GUI}
The GUI will be loaded on to a Universal Serial Bus (USB) so that it may be installed on any device that Dr. Rhinelander  desires to act as a base station. The GUI will be able to be installed on Linux, Windows and MAC devices.
